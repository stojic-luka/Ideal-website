  ...
  return (
    <>
      <Container maxWidth="lg" className="space-out">
        <Link to={"/"}>
          <picture className="">
            <source srcSet="/assets/svg/logo-small.svg" media="(max-width: 500px)" height="50px" />
            <img src="/assets/svg/logo.svg" alt="IdealDev" height={isBigScreen ? "60px" : "50px"} />
          </picture>
        </Link>
        <NavButtons />
      </Container>
    ...
    <>
      <Container maxWidth="lg" className="space-out">
        <div className="home-navbar">
          <Link to={"/"}>
            <picture>
              <source srcSet="/assets/svg/logo-small-white.svg" media="(max-width: 500px)" height="50px" />
              <img src="/assets/svg/logo-white.svg" alt="IdealDev" height={isBigScreen ? "60px" : "50px"} />
            </picture>
          </Link>
          <NavButtons />
        </div>
