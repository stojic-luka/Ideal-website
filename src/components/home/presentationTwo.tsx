          ...
          <div>
            ...
            >
              <SwiperSlide className="slider-slide">
                <div>
                  <img src="/src/assets/webp/work1.webp" alt="work" className="slider-image" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="slider-slide">
                <div>
                  <img src="/src/assets/webp/work2.webp" alt="work" className="slider-image" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="slider-slide">
                <div>
                  <img src="/src/assets/webp/work3.webp" alt="work" className="slider-image" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="slider-slide">
                <div>
                  <img src="/src/assets/webp/work4.webp" alt="work" className="slider-image" />
                </div>
              </SwiperSlide>
              <SwiperSlide className="slider-slide">
                <div>
                  <img src="/src/assets/webp/work5.webp" alt="work" className="slider-image" />
                </div>
              </SwiperSlide>
            </Swiper>
          </div>
